...
const TOGGLE_CLASS_NAME = cva([
  ...
  "h-6",
  "relative",
  "bg-ddt-common-neutral-default",
  "rounded-full",
  "cursor-pointer",
  "transition-colors",
  "duration-300",
  "appearance-none",
  "enabled:hover:bg-ddt-common-neutral-primary-hover",
  "enabled:active:bg-ddt-common-neutral-primary-press",
  ...
  "enabled:checked:hover:bg-ddt-common-brand-primary-hover",
  "enabled:checked:active:bg-ddt-common-brand-primary-press",
  "disabled:bg-ddt-common-disabled",
  ...
  "enabled:before:bg-ddt-background-default",
  "disabled:before:bg-ddt-surface-hover",
])();

...
const CHECKBOX_CLASS_NAME = cva([
  "block",
  "size-4",
  "border-ddt-common-neutral-default",
  "border-2",
  "rounded-sm",
  "relative",
  "appearance-none",

  "before:text-ddt-text-inverse",
  "before:absolute",
  "before:m-auto",
  "before:inset-0",
  ...
  "enabled:group-hover:border-ddt-common-neutral-primary-hover",
  "enabled:group-hover:bg-ddt-surface-hover",
  "enabled:group-active:border-ddt-common-neutral-primary-press",
  "enabled:group-active:bg-ddt-surface-press",

  "enabled:checked:border-ddt-common-brand",
  "enabled:checked:bg-ddt-common-brand",
  "enabled:checked:group-hover:bg-ddt-common-brand-primary-hover",
  "enabled:checked:group-hover:border-ddt-common-brand-primary-hover",
  "enabled:checked:group-hover:before:text-ddt-text-inverse",
  "enabled:checked:group-active:bg-ddt-common-brand-primary-press",
  "enabled:checked:group-active:border-ddt-common-brand-primary-press",
  "enabled:checked:group-active:before:text-ddt-text-inverse",

  "enabled:indeterminate:bg-ddt-common-brand",
  "enabled:indeterminate:border-ddt-common-brand",
  "enabled:indeterminate:group-hover:bg-ddt-common-brand-primary-hover",
  "enabled:indeterminate:group-hover:border-ddt-common-brand-primary-hover",
  "enabled:indeterminate:group-hover:before:text-ddt-text-inverse",
  "enabled:indeterminate:group-active:bg-ddt-common-brand-primary-press",
  "enabled:indeterminate:group-active:border-ddt-common-brand-primary-press",
  "enabled:indeterminate:group-active:before:text-ddt-text-inverse",

  "disabled:border-ddt-common-disabled",
  "disabled:bg-ddt-text-inverse",
  "disabled:checked:bg-ddt-common-disabled",
  "disabled:indeterminate:bg-ddt-common-disabled",
])();

...
import { DAIKIN_TAB_PANELS_ARG_TYPES, type Story } from "./common";

export default {
  title: "Components/Tab Panels",
  tags: ["autodocs"],
  argTypes: DAIKIN_TAB_PANELS_ARG_TYPES,
  ...metadata,
};
...
export const Default: Story = {
  ...
  play: definePlay(async ({ canvasElement, step }) => {
    const root = canvasElement.getElementsByTagName("daikin-tab-panels")[0];

...
const INNER_CN = cva([
  ...
  "link-enabled:before:group-hover:[&:not(:active)]:bg-ddt-surface-hover",
  "link-enabled:before:active:bg-ddt-surface-press",

  // For text
  "[&:not(a,button)]:before:group-hover:bg-ddt-surface-hover",
])();
